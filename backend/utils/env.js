...
const weakJwtSecrets = new Set(["secret", "mysecret", "mysecretkey", "mysecretkey123", "changeme"]);
...
export const validateEnv = () => {
  ...
  if (String(process.env.JWT_SECRET).length < 32 || weakJwtSecrets.has(String(process.env.JWT_SECRET))) {
...
export const getOcrProvider = () => String(process.env.OCR_PROVIDER || "none").trim().toLowerCase();
